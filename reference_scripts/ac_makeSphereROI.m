...
roisStruct(2).mni_coordinates_l = [-44, -77, -12];
roisStruct(2).mni_coordinates_r = [44, -78, -13];

% PPA ROI
roisStruct(3).roiName = 'PPA';
roisStruct(3).mni_coordinates_l = [-30, -50, -10];
roisStruct(3).mni_coordinates_r = [30, -54, -12];

% TPJ ROI
roisStruct(4).roiName = 'TPJ';
roisStruct(4).mni_coordinates_l = [-56, -47, 33];
roisStruct(4).mni_coordinates_r = [56, -47, 33];

% PCC ROI
roisStruct(5).roiName = 'PCC';
roisStruct(5).mni_coordinates_l = [2, -30, 34];
roisStruct(5).mni_coordinates_r = []; % This ROI is both hemis already
